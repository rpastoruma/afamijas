...
if (!function_exists('helpo_get_all_fonts_name')) {
    function helpo_get_all_fonts_name()
    {
        global $helpo_fonts_array;

        if (is_array($helpo_fonts_array['items'])) {
            foreach ($helpo_fonts_array['items'] as $key => $font) {
...
# Register Fonts
add_action('wp_enqueue_scripts', 'helpo_register_theme_fonts');
if (!function_exists('helpo_register_theme_fonts')) {
    function helpo_register_theme_fonts()
    {
        $fonts_array = array();

        # Menu Font
        $fonts_array[helpo_get_theme_mod('header_menu_font_family')] = ':400,500,' . helpo_get_theme_mod('header_menu_font_weight');

        # Sub Menu Font
        $fonts_array[helpo_get_theme_mod('header_sub_menu_font_family')] = ':400,500,' . helpo_get_theme_mod('header_sub_menu_font_weight');

        # Main Font
        $fonts_array[helpo_get_theme_mod('main_font_family')] = ':300,400,500,700,' . helpo_get_theme_mod('main_font_weight');

        # Headings Font
        $fonts_array[helpo_get_theme_mod('headings_font_family')] = ':400,500,' . helpo_get_theme_mod('headings_font_weight');

        # Site Title Font
        $fonts_array[helpo_get_theme_mod('site_title_font_family')] = ':400,500,700';

        # Page Title Font
        $fonts_array[helpo_get_theme_mod('page_title_font_family')] = ':300,400,500,600,700';
        ...
        wp_enqueue_style('helpo-fonts', $font_url, array());
    }
}